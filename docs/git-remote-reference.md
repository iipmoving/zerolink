...
用户: iipmoving
Token: (GitHub personal access token, stored in env)
远程名: origin
```
...
SSH: 免密登录（密钥 ~/.ssh/id_ed25519.pub 已配置到群晖）
远程名: synology
```
...
git remote add gitee https://用户名:密码@gitee.com/lipmoving/ai.git
