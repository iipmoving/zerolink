 ...
 */
/**
 * @brief 恢复PAN DMA (检锅模式: 指向 wave_capture, 2000点 @ ~0.25μs)
 *        正常模式: 指向 Pan_ADC_AdcDmaBuff[300] @ 1μs (由 Pan_ADC_DMA_BUFF_NUM 控制)
 */
...
void API_T12_EOC_IRQHandlerCallBack(void)
{
    ...
    APP_ADC_GET_TEMPE();
    API_HRTIM_Master_ENABLE_IT_CMP1();
}
