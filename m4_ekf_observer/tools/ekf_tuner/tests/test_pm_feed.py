import pytest
from m4_modbus_tool import _pm_feed, M4ModbusClient
...
def test_drain_pm_via_client():
    """M4ModbusClient.drain_pm() should extract PM frames from serial data."""
    from unittest.mock import MagicMock
    client = M4ModbusClient("COM_TEST", timeout=0.01)
