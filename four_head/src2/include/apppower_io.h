...
typedef struct {
    MODULE_INPUT_LINK(AppCommMgr, AppPower)  AppCommMgr_params;  /* 从 AppCommMgr 来 */
    MODULE_INPUT_LINK(AppProtect, AppPower)  AppProtect_params;  /* 从 AppProtect 来 */
    MODULE_INPUT_LINK(AppCooking, AppPower)  AppCooking_params;  /* 从 AppCooking 来 */
