/**
 * drvcommmgr.c —— DrvCommMgr 模块实现 (v2.3)
 *
 * 依赖: include/drvcommmgr_io.h
 * 层级: drv
 *
 ...
 *   3. 业务逻辑函数
 */
#include "include/drvcommmgr_io.h"  /* 包含 std_module.h + 三层结构定义 */
...
static MODULE_INPUT(DrvCommMgr) s_in;
...
void drvcommmgr_Init(void) { Constructor(); }
