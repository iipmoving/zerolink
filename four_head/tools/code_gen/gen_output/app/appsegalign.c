/**
 * appsegalign.c —— AppSegAlign 模块实现 (v2.3)
 *
 * 依赖: include/appsegalign_io.h
 * 层级: app
 *
 ...
 *   3. 业务逻辑函数
 */
#include "include/appsegalign_io.h"  /* 包含 std_module.h + 三层结构定义 */
...
static MODULE_INPUT(AppSegAlign) s_in;
