...
/* ---- 独立键码声明（与 drv_key.h 的 KeyCode_t 值一致，无 include 依赖）---- */
typedef enum {
    HMI_KEY_NONE = 0,
    HMI_KEY_ONOFF, HMI_KEY_SUB, HMI_KEY_ADD, HMI_KEY_STOP,
    HMI_KEY_TIME_SET, HMI_KEY_BIND, HMI_KEY_LOCK,
    HMI_KEY_RIGHT_P_SET, HMI_KEY_LEFT_P_SET,
    HMI_KEY_RIGHT_P_SET_UP, HMI_KEY_LEFT_P_SET_UP,
    HMI_KEY_POWER_0, HMI_KEY_POWER_1, HMI_KEY_POWER_2,
    HMI_KEY_POWER_3, HMI_KEY_POWER_4, HMI_KEY_POWER_5,
    HMI_KEY_POWER_6, HMI_KEY_POWER_7, HMI_KEY_POWER_8,
    HMI_KEY_POWER_9,
    HMI_KEY_COUNT
} HmiKeyCode_t;

#define HMI_KEY_STATE_PRESS   0x01u
#define HMI_KEY_STATE_LONG    0x02u
#define HMI_KEY_STATE_RELEASE 0x04u
#define HMI_KEY_STATE_REPEAT  0x08u
#define HMI_KEY_STATE_TAP     0x10u
