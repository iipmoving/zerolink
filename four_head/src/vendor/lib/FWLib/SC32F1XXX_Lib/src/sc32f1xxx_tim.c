...
#if defined(SC32f10xx) || defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx) ||defined(SC32R803)||defined(SC32R807)
 ...
 * @retval None
 */
#if defined(SC32f10xx) || defined(SC32R803)|| defined(SC32f15xx)||defined(SC32R601)||defined(SC32L14xx)||defined(SC32R807)
