 ...
 */
/* Includes ------------------------------------------------------------------*/
#if defined(SC32f12xx) || defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx) || defined (SC32f15xx) || defined (SC32R803)||defined(SC32R807)
...
void OP_Init ( OP_TypeDef* OPx, OP_InitTypeDef* OP_InitStruct )
{
    ...
    assert_param(IS_OP_GAN(OP_InitStruct->OP_PGAGain));
    ...
    tmpreg |= (uint32_t)(OP_InitStruct->OP_OutputPin | OP_InitStruct->OP_InvertInput |
      ...
      if(OP_InitStruct->OP_InvertInput == OP_InvertInput_Res )
       ...
       OP->OPX_CFG |= (uint32_t)(OP_InitStruct->OP_CMPIM1 << OP_CFG_OPCMPIM1_Pos)|(uint32_t)(OP_InitStruct->OP_REFSEL << OP_CFG_REFSEL_Pos);
       ...
       OP->OPX_CFG |= (uint32_t)(OP_InitStruct->OP_CMPIM2 << OP_CFG_OPCMPIM2_Pos)|(uint32_t)(OP_InitStruct->OP_REFSEL << OP_CFG_REFSEL_Pos);
		}
#endif
}
...
ErrorStatus OP_OffsetSet(OP_TypeDef* OPx)
{
	  ...
	  OPx_offsetchecksum1 = (uint16_t)((*((uint8_t *)0X08C00000+0x484))<<8)|(*((uint8_t *)0X08C00000+0x485));
...
{
    uint8_t OP_Pmos_offset, OP_Nmos_offset,OPx_Readoffset0,OPx_Readoffset2;
    uint32_t tmpreg ;
		uint16_t OPx_offsetchecksum0,OPx_offsetchecksum1;
    ...
    if(OPx == OP_0)
    {
        ...
        OP_Nmos_offset = *((uint8_t*)0X08C00000 + 0x493);
				...
				OPx_Readoffset0 = *((uint8_t*)0X08C00000 + 0x490);
				OPx_Readoffset2 = *((uint8_t*)0X08C00000 + 0x492);
				OPx_offsetchecksum0 = (*((uint8_t *)0X08C00000+0x490))+(*((uint8_t *)0X08C00000+0x491))+(*((uint8_t *)0X08C00000+0x492))+(*((uint8_t *)0X08C00000+0x493));
				OPx_offsetchecksum1 = (uint16_t)((*((uint8_t *)0X08C00000+0x49E))<<8)|(*((uint8_t *)0X08C00000+0x49F));
				if((OPx_Readoffset0 == 0x50) && (OPx_Readoffset2 == 0x51) && (OPx_offsetchecksum0 == OPx_offsetchecksum1))
				{
    ...
    else if(OPx == OP_1)
    {
        ...
        OP_Nmos_offset = *((uint8_t*)0X08C00000 + 0x497);
				...
				OPx_Readoffset0 = *((uint8_t*)0X08C00000 + 0x494);
				OPx_Readoffset2 = *((uint8_t*)0X08C00000 + 0x496);
				OPx_offsetchecksum0 = (*((uint8_t *)0X08C00000+0x494))+(*((uint8_t *)0X08C00000+0x495))+(*((uint8_t *)0X08C00000+0x496))+(*((uint8_t *)0X08C00000+0x497));
				OPx_offsetchecksum1 = (uint16_t)((*((uint8_t *)0X08C00000+0x49E))<<8)|(*((uint8_t *)0X08C00000+0x49F));
				if((OPx_Readoffset0 == 0x52) && (OPx_Readoffset2 == 0x53) && (OPx_offsetchecksum0 == OPx_offsetchecksum1))
				{
    ...
    else if(OPx == OP_2)
    {
        ...
        OP_Nmos_offset = *((uint8_t*)0X08C00000 + 0x49B);
				...
				OPx_Readoffset0 = *((uint8_t*)0X08C00000 + 0x498);
				OPx_Readoffset2 = *((uint8_t*)0X08C00000 + 0x49A);
				OPx_offsetchecksum0 = (*((uint8_t *)0X08C00000+0x498))+(*((uint8_t *)0X08C00000+0x499))+(*((uint8_t *)0X08C00000+0x49A))+(*((uint8_t *)0X08C00000+0x49B));
				OPx_offsetchecksum1 = (uint16_t)((*((uint8_t *)0X08C00000+0x49E))<<8)|(*((uint8_t *)0X08C00000+0x49F));
				if((OPx_Readoffset0 == 0x54) && (OPx_Readoffset2 == 0x55) && (OPx_offsetchecksum0 == OPx_offsetchecksum1))
				{
