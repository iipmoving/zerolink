...
#define IS_LCD_FRAMEFRE(FRAMEFRE) (((FRAMEFRE) == LCD_FrameFre_A32Hz) || \
                                      ...
                                      ((FRAMEFRE) == LCD_FrameFre_ACustom) || \
                                      ((FRAMEFRE) == LCD_FrameFre_BCustom))
/**
 * @}
 */
...
#elif defined(SC32L14xx)||defined(SC32R807)
typedef enum
{
    LCD_Duty_1_8 = ( uint32_t ) ( 0x00U << DDR_CFG_DUTY_Pos ),		/*!< LCD/LED display duty cycle: 1/8    */
    LCD_Duty_1_6 = ( uint32_t ) ( 0x01U << DDR_CFG_DUTY_Pos ),		/*!< LCD/LED display duty cycle: 1/6    */
    LCD_Duty_1_5 = ( uint32_t ) ( 0x02U << DDR_CFG_DUTY_Pos ),		/*!< LCD/LED display duty cycle: 1/5    */
    LCD_Duty_1_4_SEG0_54COM0_3
        = ( uint32_t ) ( 0x03U << DDR_CFG_DUTY_Pos ),								/*!< LCD/LED display duty cycle: 1/4    */
    LCD_Duty_1_4_SEG4_54COM4_7
        = ( uint32_t ) ( ( 0x03U << DDR_CFG_DUTY_Pos ) | DDR_CFG_SCS ),		/*!< LCD/LED display duty cycle: 1/4    */
} LCD_Duty_TypeDef;
...
#define IS_LCD_DUTY(DUTY) (((DUTY) == LCD_Duty_1_8) ||   \
													 ((DUTY) == LCD_Duty_1_6) ||   \
													 ((DUTY) == LCD_Duty_1_5) ||   \
													 ((DUTY) == LCD_Duty_1_4_SEG0_54COM0_3) ||   \
													 ((DUTY) == LCD_Duty_1_4_SEG4_54COM4_7))
#endif
/**
 * @}
 */
...
typedef enum
{
    LCD_ResSel_11K  = ( uint8_t ) ( 0x00U << DDR_CFG_VOIRS_Pos ), /*!< LCD voltage outlet voltage divider resistor:11K */
    LCD_ResSel_100K = ( uint8_t ) ( 0x01U << DDR_CFG_VOIRS_Pos ), /*!< LCD voltage outlet voltage divider resistor:100K */
    LCD_ResSel_300K = ( uint8_t ) ( 0x02U << DDR_CFG_VOIRS_Pos ),	/*!< LCD voltage outlet voltage divider resistor:300K */
    LCD_ResSel_800K = ( uint8_t ) ( 0x03U << DDR_CFG_VOIRS_Pos ), /*!< LCD voltage outlet voltage divider resistor:800K */
} LCD_ResSel_TypeDef;

#define IS_LCD_RESSEL(RES) (((RES) == LCD_ResSel_11K) || \
                            ((RES) == LCD_ResSel_100K) || \
                            ((RES) == LCD_ResSel_300K) || \
													  ((RES) == LCD_ResSel_800K))
#else
typedef enum
{
    LCD_ResSel_33K  = ( uint8_t ) ( 0x00U << DDR_CFG_VOIRS_Pos ), /*!< LCD voltage outlet voltage divider resistor:33K */
    LCD_ResSel_100K = ( uint8_t ) ( 0x01U << DDR_CFG_VOIRS_Pos ), /*!< LCD voltage outlet voltage divider resistor:100K */
    LCD_ResSel_300K = ( uint8_t ) ( 0x02U << DDR_CFG_VOIRS_Pos ),	/*!< LCD voltage outlet voltage divider resistor:300K */
    LCD_ResSel_800K = ( uint8_t ) ( 0x03U << DDR_CFG_VOIRS_Pos ), /*!< LCD voltage outlet voltage divider resistor:800K */
} LCD_ResSel_TypeDef;
...
#define LCD_Channel_35 (uint64_t)0x800000000
#define LCD_Channel_36 (uint64_t)0x1000000000
#define LCD_Channel_37 (uint64_t)0x2000000000
#define LCD_Channel_38 (uint64_t)0x4000000000
#define LCD_Channel_39 (uint64_t)0x8000000000
#define LCD_Channel_43 (uint64_t)0x80000000000
#define LCD_Channel_44 (uint64_t)0x100000000000
#define LCD_Channel_45 (uint64_t)0x200000000000
#define LCD_Channel_46 (uint64_t)0x400000000000
#define LCD_Channel_47 (uint64_t)0x800000000000
#define LCD_Channel_48 (uint64_t)0x1000000000000
#define LCD_Channel_52 (uint64_t)0x10000000000000
...
#define LCD_Channel_38 (uint64_t)0x4000000000
#define LCD_Channel_39 (uint64_t)0x8000000000
#define LCD_Channel_40 (uint64_t)0x10000000000
#define LCD_Channel_41 (uint64_t)0x20000000000
#define LCD_Channel_42 (uint64_t)0x40000000000
#define LCD_Channel_43 (uint64_t)0x80000000000
#define LCD_Channel_44 (uint64_t)0x100000000000
#define LCD_Channel_45 (uint64_t)0x200000000000
#define LCD_Channel_46 (uint64_t)0x400000000000
#define LCD_Channel_47 (uint64_t)0x800000000000
#define LCD_Channel_48 (uint64_t)0x1000000000000
#define LCD_Channel_49 (uint64_t)0x2000000000000
#define LCD_Channel_50 (uint64_t)0x4000000000000
#define LCD_Channel_51 (uint64_t)0x8000000000000
#define LCD_Channel_52 (uint64_t)0x10000000000000
#define LCD_Channel_53 (uint64_t)0x20000000000000
#define LCD_Channel_54 (uint64_t)0x40000000000000
#endif
#define IS_LCD_Channel(Channel) ((Channel) <= (LCD_Channel_All))
#endif
/**
...
typedef enum
{
    ...
    LCD_RAMRegister_25 = 0x00000019U,
    LCD_RAMRegister_28 = 0x0000001CU,    
		LCD_RAMRegister_35 = 0x00000023U,
    LCD_RAMRegister_36 = 0x00000024U,
    LCD_RAMRegister_37 = 0x00000025U,
    LCD_RAMRegister_38 = 0x00000026U,
    LCD_RAMRegister_39 = 0x00000027U,
    LCD_RAMRegister_43 = 0x0000002BU,
    LCD_RAMRegister_44 = 0x0000002CU,
    LCD_RAMRegister_45 = 0x0000002DU,
    LCD_RAMRegister_46 = 0x0000002EU,
    LCD_RAMRegister_47 = 0x0000002FU,
    LCD_RAMRegister_48 = 0x00000030U,
    LCD_RAMRegister_52 = 0x00000034U,
    ...
    LCD_RAMRegister_38 = 0x00000026U,
    LCD_RAMRegister_39 = 0x00000027U,
    LCD_RAMRegister_40 = 0x00000028U,
    LCD_RAMRegister_41 = 0x00000029U,
    LCD_RAMRegister_42 = 0x0000002AU,
    LCD_RAMRegister_43 = 0x0000002BU,
    LCD_RAMRegister_44 = 0x0000002CU,
    LCD_RAMRegister_45 = 0x0000002DU,
    LCD_RAMRegister_46 = 0x0000002EU,
    LCD_RAMRegister_47 = 0x0000002FU,
    LCD_RAMRegister_48 = 0x00000030U,
    LCD_RAMRegister_49 = 0x00000031U,
    LCD_RAMRegister_50 = 0x00000032U,
    LCD_RAMRegister_51 = 0x00000033U,
    LCD_RAMRegister_52 = 0x00000034U,
		LCD_RAMRegister_53 = 0x00000035U,
    LCD_RAMRegister_54 = 0x00000036U,
#endif
} LCD_RAMRegister_Typedef;
#define IS_LCD_RAM_REGISTER(REGISTER) ((REGISTER) <= (LCD_RAMRegister_54))
#endif
/**
 * @}
 */

/** @brief LCD_COMEN_Typedef
 * @{
 */
typedef enum
{
...
/** @brief LCD_PUMPClockDiv_Typedef
 * @{
 */
typedef enum
{
    LCD_PUMPClockDiv_2kHz = 0x00000000U,
    LCD_PUMPClockDiv_8kHz = 0x00000001U,
} LCD_PUMPClockDiv_Typedef;
#define IS_LCD_PUMPCLOCKDIV(PUMPCLOCKDIV) (((PUMPCLOCKDIV) == LCD_PUMPClockDiv_2kHz) || \
																		       ((PUMPCLOCKDIV) == LCD_PUMPClockDiv_8kHz))
/**
 * @}
 */
...
#elif defined (SC32R803) || defined(SC32L14xx)||defined(SC32R807)
...
void LCD_CapacitiveDriveMode ( LCD_PUMPClockDiv_Typedef LCD_PUMPCKDiv );
