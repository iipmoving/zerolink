 ...
 *          definitions and memory mapping for SC32L14XX devices.
 *
 *          This file contains:
...
/** @addtogroup SC32L14xx
  * @{
  */

#ifndef __SC32L14XX__H
#define __SC32L14XX__H
...
#define __NVIC_PRIO_BITS          2U /*!< SC32L14xx uses 2 Bits for the Priority Levels 			*/
...
/**
 * @brief SC32L14xx Interrupt Number Definition, according to the selected device
...
typedef enum
{
    ...
    /******  SC32L14xx specific Interrupt Numbers ****************************************************************/
    ...
    LPD_IRQn                    = 5,      /*!< LPD Interrupts                                                    */
    BTM_IRQn                    = 6,      /*!< BTM  Interrupts                                                   */
    UART0_2_4_IRQn              = 7,      /*!< UART0 and UART2 Interrupts                                        */
    UART1_3_5_7816_IRQn         = 8,      /*!< UART1 and UART3 Interrupts                                        */
    SPI0_TWI0_IRQn              = 9,      /*!< SPI0 Interrupts                                                   */
    SPI1_TWI1_IRQn              = 10,     /*!< SPI1 Interrupts                                                   */
    ...
    TRNG_IRQn                   = 23,     /*!< TRNG Interrupt                                                    */
    AES_IRQn              	    = 24,     /*!< AES Interrupt                                            	       */
    RTC_IRQn              	    = 25,     /*!< RTC Interrupt                                            	       */
    LPC_IRQn              	    = 26,     /*!< LPC Interrupt                                            	       */
...
typedef struct
{
    ...
    __IO uint32_t UART_DMR;
} UART_TypeDef;

/**
  * @brief SPI0 for APB0,SPI1 for APB1 ,Peripheral offset =0x60
  */
typedef struct
{
    __IO uint32_t SPI_TWI_CON;       	  /*!< SPI Control register,      Address offset: 0x00 */
    __IO uint32_t SPI_TWI_STS;          /*!< SPI Status register,       Address offset: 0x04 */
    __IO uint32_t TWI_ADD;              /*!< Reserved, 									Address offset: 0x08 */
    __IO uint32_t SPI_TWI_DATA;         /*!< SPI Data register,   			Address offset: 0x0C */
    __IO uint32_t SPI_TWI_IDE;     		  /*!< SPI Interrupt /Dma Enable register,   Address offset: 0x10 */
} SPITWI_TypeDef;
...
typedef struct
{
    __IO uint32_t TWI_CON;       	  /*!< SPI Control register,      Address offset: 0x00 */
    __IO uint32_t TWI_STS;          /*!< SPI Status register,       Address offset: 0x04 */
    __IO uint32_t TWI_ADD;              /*!< Reserved, 									Address offset: 0x08 */
    __IO uint32_t TWI_DATA;         /*!< SPI Data register,   			Address offset: 0x0C */
    __IO uint32_t TWI_IDE;     		  /*!< SPI Interrupt /Dma Enable register,   Address offset: 0x10 */
} TWI_TypeDef;
...
/**
  * @brief SP1-TWI1  APB1 ,Peripheral offset =0x60
  */
typedef struct
{
    __IO uint32_t SPI1_TWI1_CON;       	  /*!< TWI Config register,      	Address offset: 0x00 */
    __IO uint32_t SPI1_TWI1_STS;          /*!< TWI Status register,       Address offset: 0x04 */
    __IO uint32_t TWI1_ADD;               /*!< TWI Adress register, 			Address offset: 0x08 */
    __IO uint32_t SPI1_TWI1_DATA;         /*!< TWI Data register,   			Address offset: 0x0C */
    __IO uint32_t SPI1_TWI1_IDE;     		  /*!< TWI Interrupt /Dma Enable register,   Address offset: 0x10 */
} SPI1_TWI1_TypeDef;
/**
  * @brief Smart_Card_ APB1 ,Peripheral offset =0x60
  */
typedef struct
{
    __IO uint32_t SC0_CON;       	  /*!< SmartCard Config register,      	Address offset: 0x00 */
    __IO uint32_t SC0_STS;          /*!< SmartCard Flag register,       Address offset: 0x04 */
    __IO uint32_t SC0_BAUD;         /*!< SmartCard Baud Rate Configuration register, 			Address offset: 0x08 */
    __IO uint32_t SC0_DATA;         /*!< SmartCard Data register,   			Address offset: 0x0C */
    __IO uint32_t SC0_IDE;     		  /*!< SmartCard Interrupt Enable register,   Address offset: 0x10 */
} Smart_Card_TypeDef;

/**
  * @brief LPC for AHB1,Peripheral offset=0x1200
  */
typedef struct
{
    __IO uint32_t LPC_CON;         /*!< LPC Config register,      	Address offset: 0x00 */
    __IO uint32_t LPC_STS;				 /*!< LPC Flag register,      	Address offset: 0x04 */
    __IO uint32_t LPCA_CNT;				 /*!< LPC INTA active edge count value register,      	Address offset: 0x08 */
    __IO uint32_t LPCB_CNT;				 /*!< LPC INTB active edge count value register,      	Address offset: 0x0C */
    __IO uint32_t LPCA_MAX;				 /*!< LPC INTA active edge count overflow value register,      	Address offset: 0x10 */
    __IO uint32_t LPCB_MAX;     	 /*!< LPC INTB active edge count overflow value register,      	Address offset: 0x14 */
    __IO uint32_t LPC_IDE;				 /*!< LPC Interrupt Enable register,      	Address offset: 0x18 */
} LPC_TypeDef;
...
typedef struct
{
    __IO uint32_t BTM_CON;       	  /*!< BTM Control register,      Address offset: 0x00 */
    __IO uint32_t BTM_STS;          /*!< BTM Status register,       Address offset: 0x04 */
} BTM_TypeDef;
...
typedef struct
{
    __IO uint32_t OP_CON;          /*!< PGA Control register,       Address offset: 0x00 */
} OP_TypeDef;
/**
  * @brief LPD for APB2,Peripheral offset=0x190
  */
typedef struct
{
    __IO uint32_t LPD_CON;          /*!< LPD Control register,       Address offset: 0x00 */
    __IO uint32_t LPD_IDE;					/*!< LPD IDE register,       Address offset: 0x04 */
} LPD_TypeDef;
/**
  * @brief RTC for APB2,Peripheral offset=0x1B0
  */
typedef struct
{
    __IO uint32_t RTC_CON;          /*!< RTC Control register,       Address offset: 0x00 */
    __IO uint32_t RTC_CFG0;					/*!< RTC Configuration register 0,       Address offset: 0x04 */
    __IO uint32_t RTC_CFG1;					/*!< RTC Configuration register 1,       Address offset: 0x08 */
    __IO uint32_t RTC_ALARM;				/*!< RTC Alarm setting register,       Address offset: 0x0C */
    __IO uint32_t RESERVED0;				/*!< Reserved,       Address offset: 0x10 */
    __IO uint32_t RTC_STS;					/*!< RTC Flag register,       Address offset: 0x14 */
} RTC_TypeDef;
/**
  * @brief RTC for APB2,Peripheral offset=0x1E0
  */
typedef struct
{
...
typedef struct
{
    ...
    __IO uint32_t COM_EN;           /*!< COM IO Enable register register, 	  Address offset: 0x10 */
		__IO uint32_t RESERVED1[27];  /*!< Reserved,                                            Address offset: 0x14 */  
		__IO uint32_t SEGRn[55];          /*!< Display Drive Control register,      Address offset: 0x00 */
} LCD_TypeDef;
/**
  * @brief LCD_RAM for APB2,Peripheral offset=0x300
  */
typedef struct
{
    __IO uint32_t SEGR[55];          /*!< Display Drive Control register,      Address offset: 0x00 */
} LCD_RAM_TypeDef;
...
typedef struct
{
    __IO uint32_t OPINX;     		/*!< Customer option pointer register,      		Address offset: 0x00 */
    __IO uint32_t OPREG;      	/*!< Customer option register, 			Address offset: 0x04 */
} OPT_TypeDef;
...
/**
  * @brief RCC for AHB,Peripheral offset=0x300C
  */
typedef struct
{
    __IO uint32_t RCC_KEY;        /*!< RCC Protection register,    Address offset: 0x0C */
    __IO uint32_t RESERVED0;      /*!< Reserved,                Address offset: 0x10 */
    ...
    __IO uint32_t RESERVED1;      /*!< Reserved,                Address offset: 0x1C */
    ...
    __IO uint32_t NMI_CFG;        /*!< NMI_CFG    register,     Address offset: 0x2C */
} RCC_TypeDef;

/**
  * @brief AES for AHB,Peripheral offset=0x400
  */
typedef struct
{
...
#define AES_BASE               (AHBPERIPH_BASE +(0x00010400UL))
/*!< DMA */
...
#define SPI0_TWI0_BASE         (APB0PERIPH_BASE +(0x00000060UL))
...
#define SPI1_TWI1_BASE         (APB1PERIPH_BASE +(0x00000060UL))
#define UART4_BASE             (APB1PERIPH_BASE +(0x00000080UL))
#define Smart_Card_BASE				 (APB1PERIPH_BASE +(0x000000A0UL))
...
#define LPC_BASE               (APB1PERIPH_BASE +(0x00000200UL))
/*!< APB2 peripherals */
...
#define LPD_BASE               (APB2PERIPH_BASE +(0x00000190UL))
#define RTC_BASE               (APB2PERIPH_BASE +(0x000001B0UL))
#define TS_BASE              	 (APB2PERIPH_BASE +(0x000001E0UL))
#define TK_BASE                (APB2PERIPH_BASE +(0x00000200UL))
#define LCD_BASE           		 (APB2PERIPH_BASE +(0x00000280UL))
#define LCDRAM_BASE            (APB2PERIPH_BASE +(0x00000300UL))
...
#define GPIOE_BASE             (IOPORTPERIPH_BASE +(0x00000400UL))
...
#define GPIOE_BIT_BASE         (GPIOE_BASE+(0x00000000UL))
/*!< IOPORT-OverTurn */
...
#define GPIOE_OT_BASE          (GPIOE_BASE+(0x00000010UL))
/*<PA.SetBit:n=0...15>*/
...
#define PE_BIT(n)              (*((uint8_t*)((GPIOE_BIT_BASE + (n)))))
/*<PA.OverTurn:n=0...15>*/
...
#define PE_OT(n)               (*((uint8_t*)((GPIOE_OT_BASE + (n)))))=1
...
#define SPI0     			  ((SPI_TypeDef *)        SPI0_TWI0_BASE)
#define TWI0    			  ((TWI_TypeDef *)        SPI0_TWI0_BASE)
#define SPITWI_SPI0     ((SPITWI_TypeDef *)     SPI0_TWI0_BASE)
#define SPITWI_TWI0     ((SPITWI_TypeDef *)     SPI0_TWI0_BASE)
...
#define Smart_Card  		((Smart_Card_TypeDef *) Smart_Card_BASE)
...
#define GPIOE_BIT   		((GPIO_BIT_TypeDef *)   GPIOE_BIT_BASE)
//----------------------------------------------------------
...
#define RCC_CFG0_LXTSYSEN_Pos         (16U)
#define	RCC_CFG0_LXTSYSEN_Msk         (0x1UL << RCC_CFG0_LXTSYSEN_Pos)
#define RCC_CFG0_LXTSYSEN         				RCC_CFG0_LXTSYSEN_Msk
...
#define AHB_CFG_AESEN_Pos         				(5U)
#define	AHB_CFG_AESEN_Msk								  (0x1UL << AHB_CFG_AESEN_Pos)      //V0.12    
#define AHB_CFG_AESEN           					AHB_CFG_AESEN_Msk
...
#define AHB_RST_AESRST_Pos         				(5U)
#define	AHB_RST_AESRST_Msk								(0x1UL << AHB_RST_AESRST_Pos)
#define AHB_RST_AESRST           					AHB_RST_AESRST_Msk
...
#define APB0_RST_QTWI0RST_Pos         			(4U)
#define	APB0_RST_QTWI0RST_Msk							(0x1UL << APB0_RST_QTWI0RST_Pos)
#define APB0_RST_QTWI0RST           				APB0_RST_QTWI0RST_Msk
...
#define APB1_CFG_SCEN_Pos         				(9U)
#define	APB1_CFG_SCEN_Msk									(0x1UL << APB1_CFG_SCEN_Pos)
#define APB1_CFG_SCEN           					APB1_CFG_SCEN_Msk
...
#define APB1_RST_QTWI1RST_Pos              (4U)
#define	APB1_RST_QTWI1RST_Msk              (0x1UL << APB1_RST_QTWI1RST_Pos)
#define APB1_RST_QTWI1RST                  APB1_RST_QTWI1RST_Msk
...
#define APB1_RST_SCRST_Pos            		(9U)
#define	APB1_RST_SCRST_Msk             		(0x1UL << APB1_RST_SCRST_Pos)
#define APB1_RST_SCRST                  	APB1_RST_SCRST_Msk
...
#define APB2_RST_RTCRST_Pos         		(8U)
#define	APB2_RST_RTCRST_Msk							(0x1UL << APB2_RST_RTCRST_Pos)
#define APB2_RST_RTCRST           			APB2_RST_RTCRST_Msk
/************private bit *************************************/
...
#define	DDR_CON_BIAS_Msk									(0x1UL << DDR_CON_BIAS_Pos)
#define DDR_CON_BIAS          						DDR_CON_BIAS_Msk

#define DDR_CON_VOIRSF_Pos         				(3U)
#define	DDR_CON_VOIRSF_Msk								(0x1UL << DDR_CON_VOIRSF_Pos)
#define DDR_CON_VOIRSF          					DDR_CON_VOIRSF_Msk

#define DDR_CON_TYPE_Pos         					(4U)
#define	DDR_CON_TYPE_Msk									(0x1UL << DDR_CON_TYPE_Pos)
#define DDR_CON_TYPE          						DDR_CON_TYPE_Msk

#define DDR_CON_DDRON_Pos         				(7U)
#define	DDR_CON_DDRON_Msk									(0x1UL << DDR_CON_DDRON_Pos)
#define DDR_CON_DDRON          						DDR_CON_DDRON_Msk

#define DDR_CON_DDRCK_Pos         			  (8U)
#define	DDR_CON_DDRCK_Msk                 (0x3UL << DDR_CON_DDRCK_Pos)
#define DDR_CON_DDRCK          						DDR_CON_DDRCK_Msk

#define DDR_CON_PUMP_Pos         			   (10U)
#define	DDR_CON_PUMP_Msk                 (0x1UL << DDR_CON_PUMP_Pos)
#define DDR_CON_PUMP          						DDR_CON_PUMP_Msk

#define DDR_CON_LCDSEL_Pos         			  (11U)
#define	DDR_CON_LCDSEL_Msk                 (0x1UL << DDR_CON_LCDSEL_Pos )
#define DDR_CON_LCDSEL         						DDR_CON_LCDSEL_Msk


#define DDR_CON_PUMPON_Pos         			  (13U)
#define	DDR_CON_PUMPON_Msk                 (0x1UL << DDR_CON_PUMPON_Pos )
#define DDR_CON_PUMPON        						DDR_CON_PUMPON_Msk

#define DDR_CON_TRICOM_Pos         				(14U)
#define	DDR_CON_TRICOM_Msk                (0x1UL << DDR_CON_TRICOM_Pos)
#define DDR_CON_TRICOM          					DDR_CON_TRICOM_Msk

#define DDR_CON_TRIMODE_Pos         			    (15U)
#define	DDR_CON_TRIMODE_Msk							(0x1UL << DDR_CON_TRIMODE_Pos)
#define DDR_CON_TRIMODE          					DDR_CON_TRIMODE_Msk

/********************  Bit definition for DDR_CFG register  ********************/
#define DDR_CFG_VOIRS_Pos         					(0U)
#define	DDR_CFG_VOIRS_Msk                  (0x3UL << DDR_CFG_VOIRS_Pos)
#define DDR_CFG_VOIRS          						DDR_CFG_VOIRS_Msk

#define DDR_CFG_DUTY_Pos         					(4U)
#define	DDR_CFG_DUTY_Msk                  (0x3UL << DDR_CFG_DUTY_Pos)
#define DDR_CFG_DUTY          						DDR_CFG_DUTY_Msk

#define DDR_CFG_SCS_Pos         					(7U)
#define	DDR_CFG_SCS_Msk                   (0x3UL << DDR_CFG_SCS_Pos)
#define DDR_CFG_SCS                       DDR_CFG_SCS_Msk

#define DDR_CFG_VLCD_Pos         					(8U)
#define	DDR_CFG_VLCD_Msk                  (0x0FUL << DDR_CFG_VLCD_Pos)
...
#define	OP_CON_ENOP_Msk                     (0x1UL << OP_CON_ENOP_Pos)
#define OP_CON_ENOP                         OP_CON_ENOP_Msk

#define OP_CON_OPOSEL_Pos         				  (1U)
#define	OP_CON_OPOSEL_Msk         				  (0x1UL << OP_CON_OPOSEL_Pos)
#define OP_CON_OPOSEL                       OP_CON_OPOSEL_Msk

#define OP_CON_OPNSEL_Pos         				  (3U)
#define	OP_CON_OPNSEL_Msk         				  (0x1UL << OP_CON_OPNSEL_Pos)
#define OP_CON_OPNSEL         				      OP_CON_OPNSEL_Msk

#define OP_CON_OPPSEL_Pos         				  (5U)
#define	OP_CON_OPPSEL_Msk         				  (0x1UL << OP_CON_OPPSEL_Pos)
#define OP_CON_OPPSEL         				      OP_CON_OPPSEL_Msk

#define OP_CON_PGAGAIN_Pos         				    (8U)
#define	OP_CON_PGAGAIN_Msk         				    (0x3UL << OP_CON_PGAGAIN_Pos)
#define OP_CON_PGAGAIN         				        OP_CON_PGAGAIN_Msk

#define OP_CON_FDBRSEL_Pos         				  (12U)
#define	OP_CON_FDBRSEL_Msk         				  (0x3FUL << OP_CON_FDBRSEL_Pos)
#define OP_CON_FDBRSEL         				      OP_CON_FDBRSEL_Msk

#define OP_CON_TRIMOFFSETP_Pos         		  (16U)
#define	OP_CON_TRIMOFFSETP_Msk         		  (0x1UL << OP_CON_TRIMOFFSETP_Pos)
#define OP_CON_TRIMOFFSETP                  OP_CON_TRIMOFFSETP_Msk

#define OP_CON_PGAOFC_Pos         				    (23U)
#define	OP_CON_PGAOFC_Msk         				    (0x1UL << OP_CON_PGAOFC_Pos)
#define OP_CON_PGAOFC         				        OP_CON_PGAOFC_Msk

#define OP_CON_TRIMOFFSETN_Pos         		  (24U)
#define	OP_CON_TRIMOFFSETN_Msk         		  (0x1UL << OP_CON_TRIMOFFSETN_Pos)
#define OP_CON_TRIMOFFSETN                  OP_CON_TRIMOFFSETN_Pos
/******************************************************************************/
/*                                                                            */
/*                      LPD                  																*/
/*                                                                            */
/******************************************************************************/
/********************  Bit definition for LPD_CON register  ********************/
#define LPD_CON_LPDOF_Pos         				 (0U)
#define	LPD_CON_LPDOF_Msk									(0x1UL << LPD_CON_LPDOF_Pos)
#define LPD_CON_LPDOF          						LPD_CON_LPDOF_Msk

#define LPD_CON_LPDIF_Pos         				 (1U)
#define	LPD_CON_LPDIF_Msk									(0x1UL << LPD_CON_LPDIF_Pos)
#define LPD_CON_LPDIF          						LPD_CON_LPDIF_Msk

#define LPD_CON_LPDIS_Pos         				 (2U)
#define	LPD_CON_LPDIS_Msk									(0x7UL << LPD_CON_LPDIS_Pos)
#define LPD_CON_LPDIS          						LPD_CON_LPDIS_Msk

#define LPD_CON_LPDEN_Pos         				 (7U)
#define	LPD_CON_LPDEN_Msk									(0x1UL << LPD_CON_LPDEN_Pos)
#define LPD_CON_LPDEN          						LPD_CON_LPDEN_Msk
/********************  Bit definition for PWM0_CON register  ********************/
#define LPD_IDE_INTEN_Pos         				 (0U)
#define	LPD_IDE_INTEN_Msk									(0x1UL << LPD_IDE_INTEN_Pos)
#define LPD_IDE_INTEN          						LPD_IDE_INTEN_Msk
/******************************************************************************/
/*                                                                            */
/*                      PWM0                 																*/
/*                                                                            */
...
#define	SPI_CON_SPEN_Msk										(0x1UL << SPI_CON_SPEN_Pos)
#define SPI_CON_SPEN          							SPI_CON_SPEN_Msk

#define SPI_CON_QTWCK_Pos         					(8U)
#define	SPI_CON_QTWCK_Msk								  (0xFUL << SPI_CON_QTWCK_Pos)
#define SPI_CON_QTWCK          						SPI_CON_QTWCK_Msk

#define SPI_CON_SPOS_Pos         					(13U)
#define	SPI_CON_SPOS_Msk										(0x3UL << SPI_CON_SPOS_Pos)
#define SPI_CON_SPOS          							SPI_CON_SPOS_Msk

#define SPI_CON_MSTR_Pos         					(16U)
#define	SPI_CON_MSTR_Msk										(0x1UL << SPI_CON_MSTR_Pos)
#define SPI_CON_MSTR          							SPI_CON_MSTR_Msk

#define SPI_CON_DORD_Pos         					(18U)
#define	SPI_CON_DORD_Msk										(0x1UL << SPI_CON_DORD_Pos)
#define SPI_CON_DORD          							SPI_CON_DORD_Msk

#define SPI_CON_CPHA_Pos         					(19U)
#define	SPI_CON_CPHA_Msk										(0x1UL << SPI_CON_CPHA_Pos)
#define SPI_CON_CPHA          							SPI_CON_CPHA_Msk

#define SPI_CON_CPOL_Pos         					(20U)
#define	SPI_CON_CPOL_Msk										(0x1UL << SPI_CON_CPOL_Pos)
#define SPI_CON_CPOL          							SPI_CON_CPOL_Msk

#define SPI_CON_MODE_Pos         					(22U)
#define	SPI_CON_MODE_Msk										(0x1UL << SPI_CON_MODE_Pos)
#define SPI_CON_MODE          							SPI_CON_MODE_Msk

#define SPI_CON_DWIDTH_Pos         				(28U)
#define	SPI_CON_DWIDTH_Msk								  (0x1UL << SPI_CON_DWIDTH_Pos)
#define SPI_CON_DWIDTH          						SPI_CON_DWIDTH_Msk


/********************  Bit definition for SPI0_STS register  ********************/
#define SPI_STS_QTWIF_Pos         					(0U)
#define	SPI_STS_QTWIF_Msk										(0x1UL << SPI_STS_QTWIF_Pos)
#define SPI_STS_QTWIF          							SPI_STS_QTWIF_Msk

#define SPI_STS_TXEIF_Pos         					(2U)
#define	SPI_STS_TXEIF_Msk									(0x1UL << SPI_STS_TXEIF_Pos)
#define SPI_STS_TXEIF          						SPI_STS_TXEIF_Msk

#define SPI_STS_WCOL_Pos         					(7U)
#define	SPI_STS_WCOL_Msk										(0x1UL << SPI_STS_WCOL_Pos)
#define SPI_STS_WCOL          							SPI_STS_WCOL_Msk
/********************  Bit definition for SPI0_IDE register  ********************/
#define SPI_IDE_INTEN_Pos         					(0U)
#define	SPI_IDE_INTEN_Msk									(0x1UL << SPI_IDE_INTEN_Pos)
#define SPI_IDE_INTEN         							SPI_IDE_INTEN_Msk

#define SPI_IDE_TBIE_Pos         					(2U)
#define	SPI_IDE_TBIE_Msk										(0x1UL << SPI_IDE_TBIE_Pos)
#define SPI_IDE_TBIE        								SPI_IDE_TBIE_Msk

#define SPI_IDE_RXDMAEN_Pos         				(6U)
#define	SPI_IDE_RXDMAEN_Msk								(0x1UL << SPI_IDE_RXDMAEN_Pos)
#define SPI_IDE_RXDMAEN        						SPI_IDE_RXDMAEN_Msk

#define SPI_IDE_TXDMAEN_Pos         				(7U)
#define	SPI_IDE_TXDMAEN_Msk								(0x1UL << SPI_IDE_TXDMAEN_Pos)
...
/*                                                                            */
/******************************************************************************/
/********************  Bit definition for LPC_CON register  ********************/
#define LPC_CON_INITDIR_Pos         						(0U)
#define	LPC_CON_INITDIR_Msk											(0x1UL << LPC_CON_INITDIR_Pos)
#define LPC_CON_INITDIR         								LPC_CON_INITDIR_Msk

#define LPC_CON_DISDIR_Pos         							(1U)
#define	LPC_CON_DISDIR_Msk											(0x1UL << LPC_CON_DISDIR_Pos)
#define LPC_CON_DISDIR         									LPC_CON_DISDIR_Msk

#define LPC_CON_RFSELA_Pos         							(4U)
#define	LPC_CON_RFSELA_Msk											(0x1UL << LPC_CON_RFSELA_Pos)
#define LPC_CON_RFSELA         									LPC_CON_RFSELA_Msk

#define LPC_CON_RFSELB_Pos         							(5U)
#define	LPC_CON_RFSELB_Msk											(0x1UL << LPC_CON_RFSELB_Pos)
#define LPC_CON_RFSELB         									LPC_CON_RFSELB_Msk

#define LPC_CON_LPCTEN_Pos         							(7U)
#define	LPC_CON_LPCTEN_Msk											(0x1UL << LPC_CON_LPCTEN_Pos)
#define LPC_CON_LPCTEN         									LPC_CON_LPCTEN_Msk
/********************  Bit definition for LPC_STS register  ********************/
#define LPC_STS_FLIPIF_Pos         						(0U)
#define	LPC_STS_FLIPIF_Msk									  (0x1UL << LPC_STS_FLIPIF_Pos)
#define LPC_STS_FLIPIF         								LPC_STS_FLIPIF_Msk

#define LPC_STS_DIRIF_Pos         						(1U)
#define	LPC_STS_DIRIF_Msk											(0x1UL << LPC_STS_DIRIF_Pos)
#define LPC_STS_DIRIF         								LPC_STS_DIRIF_Msk

#define LPC_STS_CAIF_Pos         							(2U)
#define	LPC_STS_CAIF_Msk											(0x1UL << LPC_STS_CAIF_Pos)
#define LPC_STS_CAIF         									LPC_STS_CAIF_Msk

#define LPC_STS_CBIF_Pos         							(3U)
#define	LPC_STS_CBIF_Msk											(0x1UL << LPC_STS_CBIF_Pos)
#define LPC_STS_CBIF         									LPC_STS_CBIF_Msk

#define LPC_STS_RFAIF_Pos         							(4U)
#define	LPC_STS_RFAIF_Msk											(0x1UL << LPC_STS_RFAIF_Pos)
#define LPC_STS_RFAIF         									LPC_STS_RFAIF_Msk

#define LPC_STS_RFBIF_Pos         							(5U)
#define	LPC_STS_RFBIF_Msk											(0x1UL << LPC_STS_RFBIF_Pos)
#define LPC_STS_RFBIF         									LPC_STS_RFBIF_Msk
/********************  Bit definition for LPCA_CNT register  ********************/
#define LPC_LPCA_CNT_Pos         						(0U)
#define	LPC_LPCA_CNT_Msk											(0xFFUL << LPC_LPCA_CNT_Pos)
#define LPC_LPCA_CNT        								LPC_LPCA_CNT_Msk
/********************  Bit definition for LPCB_CNT register  ********************/
#define LPC_LPCB_CNT_Pos         						(0U)
#define	LPC_LPCB_CNT_Msk											(0xFFUL << LPC_LPCB_CNT_Pos)
#define LPC_LPCB_CNT        								LPC_LPCB_CNT_Msk
/********************  Bit definition for LPCA_MAX register  ********************/
#define LPC_LPCA_MAX_Pos         						(0U)
#define	LPC_LPCA_MAX_Msk											(0xFFUL << LPC_LPCA_MAX_Pos)
#define LPC_LPCA_MAX        								LPC_LPCA_MAX_Msk
/********************  Bit definition for LPCB_MAX register  ********************/
#define LPC_LPCB_MAX_Pos         						(0U)
#define	LPC_LPCB_MAX_Msk											(0xFFUL << LPC_LPCB_MAX_Pos)
#define LPC_LPCB_MAX        								LPC_LPCB_MAX_Msk
/********************  Bit definition for LPC_IDE register  ********************/
#define LPC_IDE_INTEN_Pos         						(0U)
#define	LPC_IDE_INTEN_Msk											(0x1UL << LPC_IDE_INTEN_Pos)
#define LPC_IDE_INTEN        								LPC_IDE_INTEN_Msk

#define LPC_IDE_DIRIE_Pos         						(1U)
#define	LPC_IDE_DIRIE_Msk											(0x1UL << LPC_IDE_DIRIE_Pos)
#define LPC_IDE_DIRIE        								LPC_IDE_DIRIE_Msk

#define LPC_IDE_CAIE_Pos         							(2U)
#define	LPC_IDE_CAIE_Msk											(0x1UL << LPC_IDE_CAIE_Pos)
#define LPC_IDE_CAIE        									LPC_IDE_CAIE_Msk

#define LPC_IDE_CBIE_Pos         							(3U)
#define	LPC_IDE_CBIE_Msk											(0x1UL << LPC_IDE_CBIE_Pos)
#define LPC_IDE_CBIE        									LPC_IDE_CBIE_Msk

#define LPC_IDE_RFAIE_Pos         							(4U)
#define	LPC_IDE_RFAIE_Msk											(0x1UL << LPC_IDE_RFAIE_Pos)
#define LPC_IDE_RFAIE        									LPC_IDE_RFAIE_Msk

#define LPC_IDE_RFBIE_Pos         							(5U)
#define	LPC_IDE_RFBIE_Msk											(0x1UL << LPC_IDE_RFBIE_Pos)
#define LPC_IDE_RFBIE        									LPC_IDE_RFBIE_Msk
/******************************************************************************/
/*                                                                            */
/*                      TK               																*/
/*                                                                            */
...
#define TK_TK_TM_Msk          		          (0xFFFFUL << TK_TK_TM_Pos)          
...
#define	TWI_CON_STRETCH_Msk										(0x1UL << TWI_CON_STRETCH_Pos)
#define TWI_CON_STRETCH         							TWI_CON_STRETCH_Msk

#define TWI_CON_AA_Pos         								(1U)
#define	TWI_CON_AA_Msk												(0x1UL << TWI_CON_AA_Pos)
#define TWI_CON_AA         										TWI_CON_AA_Msk

#define TWI_CON_STO_Pos         							(4U)
#define	TWI_CON_STO_Msk												(0x1UL << TWI_CON_STO_Pos)
#define TWI_CON_STO         									TWI_CON_STO_Msk

#define TWI_CON_STA_Pos         							(5U)
#define	TWI_CON_STA_Msk												(0x1UL << TWI_CON_STA_Pos)
#define TWI_CON_STA         									TWI_CON_STA_Msk

#define TWI_CON_QTWEN_Pos         							(7U)
#define	TWI_CON_QTWEN_Msk											(0x1UL << TWI_CON_QTWEN_Pos)
#define TWI_CON_QTWEN         									TWI_CON_QTWEN_Msk

#define TWI_CON_QTWCK_Pos         							(8U)
#define	TWI_CON_QTWCK_Msk											(0x0FUL << TWI_CON_QTWCK_Pos)
#define TWI_CON_QTWCK         									TWI_CON_QTWCK_Msk

#define TWI_CON_SPOS_Pos         							(13U)
#define	TWI_CON_SPOS_Msk											(0x3UL << TWI_CON_SPOS_Pos)
#define TWI_CON_SPOS         									TWI_CON_SPOS_Msk
/********************  Bit definition for TWI_STS register  ********************/
#define TWI_STS_QTWIF_Pos         						(0U)
#define	TWI_STS_QTWIF_Msk											(0x1UL << TWI_STS_QTWIF_Pos)
#define TWI_STS_QTWIF         								TWI_STS_QTWIF_Msk

#define TWI_STS_STATE_Pos         						(8U)
#define	TWI_STS_STATE_Msk											(0x7UL << TWI_STS_STATE_Pos)
#define TWI_STS_STATE         								TWI_STS_STATE_Msk

#define TWI_STS_TXERXE_Pos         						(12U)
#define	TWI_STS_TXERXE_Msk										(0x1UL << TWI_STS_TXERXE_Pos)
#define TWI_STS_TXERXE         								TWI_STS_TXERXE_Msk

#define TWI_STS_GCA_Pos         							(13U)
#define	TWI_STS_GCA_Msk												(0x1UL << TWI_STS_GCA_Pos)
#define TWI_STS_GCA         									TWI_STS_GCA_Msk

#define TWI_STS_MSTR_Pos         							(14U)
#define	TWI_STS_MSTR_Msk											(0x1UL << TWI_STS_MSTR_Pos)
#define TWI_STS_MSTR         									TWI_STS_MSTR_Msk

#define TWI_STS_NBYTES_Pos         						(16U)
#define	TWI_STS_NBYTES_Msk										(0xFFUL << TWI_STS_NBYTES_Pos)
#define TWI_STS_NBYTES         								TWI_STS_NBYTES_Msk

#define TWI_CON_MODE_Pos         					(22U)
#define	TWI_CON_MODE_Msk										(0x1UL << TWI_CON_MODE_Pos)
#define TWI_CON_MODE          							TWI_CON_MODE_Msk

/********************  Bit definition for TWI_ADD register  ********************/
#define TWI_ADD_GC_Pos         							(0U)
#define	TWI_ADD_GC_Msk											(0x1UL << TWI_ADD_GC_Pos)
#define TWI_ADD_GC         									TWI_ADD_GC_Msk

#define TWI_ADD_TWA_Pos         						(1U)
#define	TWI_ADD_TWA_Msk										  (0x7FUL << TWI_ADD_TWA_Pos)
#define TWI_ADD_TWA         								TWI_ADD_TWA_Msk

/********************  Bit definition for TWI_IDE register  ********************/
#define TWI_IDE_INTEN_Pos         						(0U)
#define	TWI_IDE_INTEN_Msk											(0x1UL << TWI_IDE_INTEN_Pos)
#define TWI_IDE_INTEN         								TWI_IDE_INTEN_Msk

#define TWI_IDE_RXDMAEN_Pos         					(6U)
#define	TWI_IDE_RXDMAEN_Msk										(0x1UL << TWI_IDE_RXDMAEN_Pos)
#define TWI_IDE_RXDMAEN         							TWI_IDE_RXDMAEN_Msk

#define TWI_IDE_TXDMAEN_Pos         					(7U)
#define	TWI_IDE_TXDMAEN_Msk										(0x1UL << TWI_IDE_TXDMAEN_Pos)
...
/*                                                                            */
/******************************************************************************/
#define SC_CON_PCS_Pos         				(0U)
#define	SC_CON_PCS_Msk								(0x1UL << SC_CON_PCS_Pos)
#define SC_CON_PCS        						SC_CON_PCS_Msk

#define SC_CON_TRE_Pos         				(1U)
#define	SC_CON_TRE_Msk								(0x1UL << SC_CON_TRE_Pos)
#define SC_CON_TRE        						SC_CON_TRE_Msk

#define SC_CON_CONS_Pos         			(2U)
#define	SC_CON_CONS_Msk								(0x1UL << SC_CON_CONS_Pos)
#define SC_CON_CONS        						SC_CON_CONS_Msk

#define SC_CON_ERS_Pos         				(3U)
#define	SC_CON_ERS_Msk								(0x3UL << SC_CON_ERS_Pos)
#define SC_CON_ERS        						SC_CON_ERS_Msk

#define SC_CON_TREN_Pos         			(5U)
#define	SC_CON_TREN_Msk								(0x1UL << SC_CON_TREN_Pos)
#define SC_CON_TREN        						SC_CON_TREN_Msk

#define SC_CON_CKEN_Pos         			(6U)
#define	SC_CON_CKEN_Msk								(0x1UL << SC_CON_CKEN_Pos)
#define SC_CON_CKEN        						SC_CON_CKEN_Msk

#define SC_CON_SCEN_Pos         			(7U)
#define	SC_CON_SCEN_Msk								(0x1UL << SC_CON_SCEN_Pos)
#define SC_CON_SCEN        						SC_CON_SCEN_Msk

#define SC_CON_SPOS_Pos         			(13U)
#define	SC_CON_SPOS_Msk								(0x3UL << SC_CON_SPOS_Pos)
#define SC_CON_SPOS        						SC_CON_SPOS_Msk
/********************  Bit definition for SMART_CARD_STS register  ********************/
#define SC_STS_RC_Pos         				(0U)
#define	SC_STS_RC_Msk									(0x1UL << SC_STS_RC_Pos)
#define SC_STS_RC        							SC_STS_RC_Msk

#define SC_STS_TC_Pos         				(1U)
#define	SC_STS_TC_Msk									(0x1UL << SC_STS_TC_Pos)
#define SC_STS_TC        							SC_STS_TC_Msk

#define SC_STS_ROVF_Pos         			(2U)
#define	SC_STS_ROVF_Msk								(0x1UL << SC_STS_ROVF_Pos)
#define SC_STS_ROVF        						SC_STS_ROVF_Msk

#define SC_STS_FER_Pos         				(3U)
#define	SC_STS_FER_Msk								(0x1UL << SC_STS_FER_Pos)
#define SC_STS_FER        						SC_STS_FER_Msk

#define SC_STS_WTER_Pos         			(4U)
#define	SC_STS_WTER_Msk								(0x1UL << SC_STS_WTER_Pos)
#define SC_STS_WTER        						SC_STS_WTER_Msk

#define SC_STS_RPER_Pos         			(5U)
#define	SC_STS_RPER_Msk								(0x1UL << SC_STS_RPER_Pos)
#define SC_STS_RPER        						SC_STS_RPER_Msk

#define SC_STS_TPER_Pos         			(6U)
#define	SC_STS_TPER_Msk								(0x1UL << SC_STS_TPER_Pos)
#define SC_STS_TPER        						SC_STS_TPER_Msk

#define SC_STS_RBUSY_Pos         			(8U)
#define	SC_STS_RBUSY_Msk							(0x1UL << SC_STS_RBUSY_Pos)
#define SC_STS_RBUSY        					SC_STS_RBUSY_Msk

#define SC_STS_TBUSY_Pos         			(9U)
#define	SC_STS_TBUSY_Msk							(0x1UL << SC_STS_TBUSY_Pos)
#define SC_STS_TBUSY        					SC_STS_TBUSY_Msk

#define SC_STS_WTRT_Pos         			(10U)
#define	SC_STS_WTRT_Msk								(0x1UL << SC_STS_WTRT_Pos)
#define SC_STS_WTRT        						SC_STS_WTRT_Msk
/********************  Bit definition for SMART_CARD_BAUD register  ********************/
#define SC_BAUD_ETUCK_Pos         		(0U)
#define	SC_BAUD_ETUCK_Msk							(0xFFFUL << SC_BAUD_ETUCK_Pos)
#define SC_BAUD_ETUCK        					SC_BAUD_ETUCK_Msk

#define SC_BAUD_SCCK_Pos         			(16U)
#define	SC_BAUD_SCCK_Msk							(0x1FUL << SC_BAUD_SCCK_Pos)
#define SC_BAUD_SCCK        					SC_BAUD_SCCK_Msk

#define SC_BAUD_EGT_Pos         			(24U)
#define	SC_BAUD_EGT_Msk								(0xFFUL << SC_BAUD_EGT_Pos)
#define SC_BAUD_EGT        						SC_BAUD_EGT_Msk
/********************  Bit definition for SMART_CARD_DATA register  ********************/
#define SC_DATA_SCD_Pos         			(0U)
#define	SC_DATA_SCD_Msk								(0xFUL << SC_DATA_SCD_Pos)
#define SC_DATA_SCD        						SC_DATA_SCD_Msk
/********************  Bit definition for SMART_CARD_IDE register  ********************/
#define SC_IDE_INTEN_Pos              (0U)
#define	SC_IDE_INTEN_Msk							(0x1UL << SC_IDE_INTEN_Pos)
#define SC_IDE_INTEN        					SC_IDE_INTEN_Msk

#define SC_IDE_RXIE_Pos         			(1U)
#define	SC_IDE_RXIE_Msk							  (0x1UL << SC_IDE_RXIE_Pos)
#define SC_IDE_RXIE        					  SC_IDE_RXIE_Msk

#define SC_IDE_TXIE_Pos         			(2U)
#define	SC_IDE_TXIE_Msk							  (0x1UL << SC_IDE_TXIE_Pos)
#define SC_IDE_TXIE        					  SC_IDE_TXIE_Msk

#define SC_IDE_ERRIE_Pos         			(3U)
#define	SC_IDE_ERRIE_Msk							(0x1UL << SC_IDE_ERRIE_Pos)
#define SC_IDE_ERRIE        					SC_IDE_ERRIE_Msk
...
#define RTC_CON_CT_Pos         					(0U)
#define	RTC_CON_CT_Msk									(0x7UL << RTC_CON_CT_Pos)
#define RTC_CON_CT         							RTC_CON_CT_Msk

#define RTC_CON_RTCSEL_Pos         					(3U)
#define	RTC_CON_RTCSEL_Msk									(0x1UL << RTC_CON_RTCSEL_Pos)
#define RTC_CON_RTCSEL       							RTC_CON_RTCSEL_Msk

#define RTC_CON_AMPM_Pos         					(5U)
#define	RTC_CON_AMPM_Msk									(0x1UL << RTC_CON_AMPM_Pos)
#define RTC_CON_AMPM         							RTC_CON_AMPM_Msk

#define RTC_CON_INTEN_Pos         					(8U)
#define	RTC_CON_INTEN_Msk									(0x1UL << RTC_CON_INTEN_Pos)
#define RTC_CON_INTEN         							RTC_CON_INTEN_Msk

#define RTC_CON_WALIE_Pos         					(9U)
#define	RTC_CON_WALIE_Msk									(0x1UL << RTC_CON_WALIE_Pos)
#define RTC_CON_WALIE         							RTC_CON_WALIE_Msk

/********************  Bit definition for RTC_STS register  ********************/
#define RTC_STS_WALIF_Pos         					(0U)
#define	RTC_STS_WALIF_Msk									(0x1UL << RTC_STS_WALIF_Pos)
#define RTC_STS_WALIF         							RTC_STS_WALIF_Msk

#define RTC_STS_RTCCTIF_Pos         					(1U)
#define	RTC_STS_RTCCTIF_Msk									(0x1UL << RTC_STS_RTCCTIF_Pos)
#define RTC_STS_RTCCTIF        							RTC_STS_RTCCTIF_Msk

/********************  Bit definition for RTC_CFG0 register  ********************/
#define RTC_CFG0_DAY_Pos         					(0U)
#define	RTC_CFG0_DAY_Msk									(0x3FUL << RTC_CFG0_DAY_Pos)
#define RTC_CFG0_DAY         							RTC_CFG0_DAY_Msk

#define RTC_CFG0_WEEK_Pos         					(8U)
#define	RTC_CFG0_WEEK_Msk									(0x7UL << RTC_CFG0_WEEK_Pos)
#define RTC_CFG0_WEEK        							RTC_CFG0_WEEK_Msk

#define RTC_CFG0_MONTH_Pos         					(16U)
#define	RTC_CFG0_MONTH_Msk									(0x1FUL << RTC_CFG0_MONTH_Pos)
#define RTC_CFG0_MONTH         							RTC_CFG0_MONTH_Msk

#define RTC_CFG0_YEAR_Pos         					(24U)
#define	RTC_CFG0_YEAR_Msk									(0xFFUL << RTC_CFG0_YEAR_Pos)
#define RTC_CFG0_YEAR        							RTC_CFG0_YEAR_Msk

/********************  Bit definition for RTC_CFG1 register  ********************/
#define RTC_CFG1_SEC_Pos         					(0U)
#define	RTC_CFG1_SEC_Msk									(0x7FUL << RTC_CFG1_SEC_Pos)
#define RTC_CFG1_SEC         							RTC_CFG1_SEC_Msk

#define RTC_CFG1_HSEC_Pos         					(7U)
#define	RTC_CFG1_HSEC_Msk									(0x1UL << RTC_CFG1_HSEC_Pos)
#define RTC_CFG1_HSEC        							RTC_CFG1_HSEC_Msk

#define RTC_CFG1_MIN_Pos         					(8U)
#define	RTC_CFG1_MIN_Msk									(0x7FUL << RTC_CFG1_MIN_Pos)
#define RTC_CFG1_MIN        							RTC_CFG1_MIN_Msk

#define RTC_CFG1_HOUR_Pos         					(16U)
#define	RTC_CFG1_HOUR_Msk									(0x3FUL << RTC_CFG1_HOUR_Pos)
#define RTC_CFG1_HOUR         							RTC_CFG1_HOUR_Msk

/********************  Bit definition for RTC_ALARM register  ********************/
#define RTC_ALARM_WM_Pos         					(0U)
#define	RTC_ALARM_WM_Msk									(0x7FUL << RTC_ALARM_WM_Pos)
#define RTC_ALARM_WM         							RTC_ALARM_WM_Msk

#define RTC_ALARM_WH_Pos         					(8U)
#define	RTC_ALARM_WH_Msk									(0x3FUL << RTC_ALARM_WH_Pos)
#define RTC_ALARM_WH         							RTC_ALARM_WH_Msk

#define RTC_ALARM_WW_Pos         					(16U)
#define	RTC_ALARM_WW_Msk									(0x7FUL << RTC_ALARM_WW_Pos)
#define RTC_ALARM_WW         							RTC_ALARM_WW_Msk
...
/*                                                                            */
/******************************************************************************/
/********************  Bit definition for TS_CFG register  ********************/
#define TS_CFG_CHOP_Pos         					(0U)
#define	TS_CFG_CHOP_Msk									(0x1UL << TS_CFG_CHOP_Pos)
#define TS_CFG_CHOP         							TS_CFG_CHOP_Msk

/********************  Bit definition for WDT_CFG register  ********************/
#define TS_CFG_EN_Pos         					(7U)
#define	TS_CFG_EN_Msk									(0x1UL << TS_CFG_EN_Pos)
...
#define	WDT_CON_CLRWDT_Msk									(0x1UL << WDT_CON_CLRWDT_Pos)
#define WDT_CON_CLRWDT         							WDT_CON_CLRWDT_Msk

/********************  Bit definition for WDT_CFG register  ********************/
#define WDT_CFG_WDTCKS_Pos         					(0U)
#define	WDT_CFG_WDTCKS_Msk									(0x7UL << WDT_CFG_WDTCKS_Pos)
...
#define TRNG_CFG_TRNGEN_Pos         				(7U)
#define	TRNG_CFG_TRNGEN_Msk									(0x1UL << TRNG_CFG_TRNGEN_Pos)
#define TRNG_CFG_TRNGEN         						TRNG_CFG_TRNGEN_Msk

#define AES_CFG_SUSPEN_Pos         					(8U)
#define	AES_CFG_SUSPEN_Msk									(0x1UL << AES_CFG_SUSPEN_Pos)
#define AES_CFG_SUSPEN         							AES_CFG_SUSPEN_Msk

#define AES_CFG_CCFIE_Pos         					(9U)
#define	AES_CFG_CCFIE_Msk									  (0x1UL << AES_CFG_CCFIE_Pos)
#define AES_CFG_CCFIE         							AES_CFG_CCFIE_Msk

#define TRNG_CFG_TINTEN_Pos         				(10U)
#define	TRNG_CFG_TINTEN_Msk									(0x1UL << TRNG_CFG_TINTEN_Pos)
#define TRNG_CFG_TINTEN         						TRNG_CFG_TINTEN_Msk

#define TRNG_CFG_DRDYIE_Pos         				(11U)
#define	TRNG_CFG_DRDYIE_Msk									(0x1UL << TRNG_CFG_DRDYIE_Pos)
#define TRNG_CFG_DRDYIE         						TRNG_CFG_DRDYIE_Msk

#define AES_CFG_MODE_Pos         					  (15U)
#define	AES_CFG_MODE_Msk									  (0x1UL << AES_CFG_MODE_Pos)
#define AES_CFG_MODE         							  AES_CFG_MODE_Msk
/********************  Bit definition for TRNG_STS register  ********************/
#define ASE_STS_BUSY_Pos         					  (0U)
#define	ASE_STS_BUSY_Msk									  (0x1UL << ASE_STS_BUSY_Pos)
#define ASE_STS_BUSY         							  ASE_STS_BUSY_Msk

#define ASE_STS_CCFIF_Pos         					(1U)
#define	ASE_STS_CCFIF_Msk									  (0x1UL << ASE_STS_CCFIF_Pos)
#define ASE_STS_CCFIF         							ASE_STS_CCFIF_Msk

#define TRNG_STS_SEIF_Pos         					(2U)
#define	TRNG_STS_SEIF_Msk									  (0x1UL << TRNG_STS_SEIF_Pos)
#define TRNG_STS_SEIF         							TRNG_STS_SEIF_Msk

#define TRNG_STS_DRDYIF_Pos         				(3U)
#define	TRNG_STS_DRDYIF_Msk									(0x1UL << TRNG_STS_DRDYIF_Pos)
#define TRNG_STS_DRDYIF         						TRNG_STS_DRDYIF_Msk
/******************************************************************************/


/**********  Configure the unrouted pins as strong push-pull outputs  **********/
#define  SC32L14xMx_NIO_Init()   do{*(uint32_t*)(GPIOE_BIT_BASE+0X00000020) |= ( uint32_t ) 0x00000080;}while(0)

#define  SC32L14xRx_NIO_Init()   do{*(uint32_t*)(GPIOA_BIT_BASE+0X00000020) |= ( uint32_t ) 0x00000300;\
																	*(uint32_t*)(GPIOB_BIT_BASE+0X00000020) |= ( uint32_t ) 0x0000319C;\
																	*(uint32_t*)(GPIOD_BIT_BASE+0X00000020) |= ( uint32_t ) 0x0000C380;\
																	*(uint32_t*)(GPIOE_BIT_BASE+0X00000020) |= ( uint32_t ) 0x000000A1;}while(0)

#define  SC32L14xCx_NIO_Init()   do{*(uint32_t*)(GPIOA_BIT_BASE+0X00000020) |= ( uint32_t ) 0x00008700;\
																	*(uint32_t*)(GPIOB_BIT_BASE+0X00000020) |= ( uint32_t ) 0x000003FF;\
																	*(uint32_t*)(GPIOC_BIT_BASE+0X00000020) |= ( uint32_t ) 0x0000FFC0;\
																	*(uint32_t*)(GPIOD_BIT_BASE+0X00000020) |= ( uint32_t ) 0x0000C000;\
																	*(uint32_t*)(GPIOE_BIT_BASE+0X00000020) |= ( uint32_t ) 0x000000BF;}while(0)
