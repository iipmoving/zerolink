...
#if defined(SC32f10xx) ||defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)||defined(SC32R807)
...
typedef enum
{
    SPI_Mode_Slave = ( uint32_t ) ( 0X00U << SPI_CON_MSTR_Pos ), /*!< SPI Mode:Slave   */
    SPI_Mode_Master = ( uint32_t ) ( 0X01U << SPI_CON_MSTR_Pos ), /*!< SPI Mode:Master    */
} SPI_Mode_TypeDef;
...
typedef enum
{
    SPI_DataSize_8B  = ( uint32_t ) ( 0X00U << SPI_CON_DWIDTH_Pos ), /*!< SPI Data Size:Set data frame format to 8bit    */
    SPI_DataSize_16B = ( uint32_t ) ( 0X01U << SPI_CON_DWIDTH_Pos ), /*!< SPI Data Size:Set data frame format to 16bit   */
...
typedef enum
{
    SPI_FirstBit_MSB = ( uint32_t ) ( 0X00U << SPI_CON_DORD_Pos ), /*!< SPI First Bit:MSB    */
    SPI_FirstBit_LSB = ( uint32_t ) ( 0X01U << SPI_CON_DORD_Pos ), /*!< SPI First Bit:LSB    */
...
typedef enum
{
    SPI_CPHA_1Edge = ( uint32_t ) ( 0X00U << SPI_CON_CPHA_Pos ), /*!< SPI Clock Phase:The first edge signal is triggered   */
    SPI_CPHA_2Edge = ( uint32_t ) ( 0X01U << SPI_CON_CPHA_Pos ), /*!< SPI Clock Phase:The second edge signal is triggered    */
} SPI_CPHA_TypeDef;
...
typedef enum
{
    SPI_CPOL_Low  = ( uint32_t ) ( 0X00U << SPI_CON_CPOL_Pos ), /*!< SPI Clock Polarity:It is low in the idle state  */
    SPI_CPOL_High = ( uint32_t ) ( 0X01U << SPI_CON_CPOL_Pos ), /*!< SPI Clock Polarity:It is high in the idle state    */
} SPI_CPOL_TypeDef;
...
typedef enum
{
    SPI_Prescaler_1 = 0x00U << SPI_CON_QTWCK_Pos,    /*!< Clock division: Fsource/1    */
    SPI_Prescaler_2 = 0x01U << SPI_CON_QTWCK_Pos,    /*!< Clock division: Fsource/2    */
    SPI_Prescaler_4 = 0x02U << SPI_CON_QTWCK_Pos,    /*!< Clock division: Fsource/4    */
    SPI_Prescaler_8 = 0x03U << SPI_CON_QTWCK_Pos,    /*!< Clock division: Fsource/8    */
    SPI_Prescaler_16 = 0x04U << SPI_CON_QTWCK_Pos,   /*!< Clock division: Fsource/16    */
    SPI_Prescaler_32 = 0x05U << SPI_CON_QTWCK_Pos,   /*!< Clock division: Fsource/32    */
    SPI_Prescaler_64 = 0x06U << SPI_CON_QTWCK_Pos,   /*!< Clock division: Fsource/64    */
    SPI_Prescaler_128 = 0x07U << SPI_CON_QTWCK_Pos,  /*!< Clock division: Fsource/128    */
    SPI_Prescaler_256 = 0x08U << SPI_CON_QTWCK_Pos,  /*!< Clock division: Fsource/256    */
    SPI_Prescaler_512 = 0x09U << SPI_CON_QTWCK_Pos,  /*!< Clock division: Fsource/512    */
    SPI_Prescaler_1024 = 0x0AU << SPI_CON_QTWCK_Pos, /*!< Clock division: Fsource/1024    */
		SPI_Prescaler_2048 = 0x0BU << SPI_CON_QTWCK_Pos, /*!< Clock division: Fsource/2048    */
		SPI_Prescaler_4096 = 0x0CU << SPI_CON_QTWCK_Pos, /*!< Clock division: Fsource/4096    */
...
#define IS_SPI_LIST2_PINREMAP(REMAP) (((REMAP) == SPI_PinRemap_Default) ||  \
															      	((REMAP) == SPI_PinRemap_A))
#elif  defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)||defined(SC32R807)
typedef enum
{
    SPI_PinRemap_Default = ( uint32_t ) ( 0x00 << SPI_CON_SPOS_Pos ), /*!< TIM Pin Remap: Disable */
    SPI_PinRemap_A       = ( uint32_t ) ( 0x01 << SPI_CON_SPOS_Pos ), /*!< TIM Pin Remap: Remap mode A */
...
typedef enum
{
    ...
    SPI_IT_TBIE    = ( uint32_t ) SPI_IDE_TBIE,  		/*!< SPI Interrupt: SPI TX buffer is empty Interrupt */
} SPI_IT_TypeDef;
...
typedef enum
{
    SPI_FLAG_QTWIF   = ( uint32_t ) SPI_STS_QTWIF, /*!< SPI Flag: SPI transmit and receive flag */
...
#define IS_SPI_FLAG(FLAG) (((FLAG) == SPI_FLAG_QTWIF) || \
                           ((FLAG) == SPI_Flag_TXEIF) || \
                           ((FLAG) == SPI_Flag_WCOL))
#else
typedef enum
...
/** @brief SPI_Constants SPI Constants
  * @{
  */
#if defined(SC32f10xx) || defined(SC32L14xx)||defined(SC32R807)
