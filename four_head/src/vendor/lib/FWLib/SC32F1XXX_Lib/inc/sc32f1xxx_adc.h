...
typedef enum
{
    ...
    ADC_Channel_OP     = ( uint16_t ) 0x1E,		 /*!< ADC_CHANNEL OP */
		ADC_Channel_VDD_D4 = ( uint16_t ) 0x1F,		 /*!< ADC_CHANNEL VDD Divide 4 */
#elif defined(SC32L14xx)
    ADC_Channel_16     = ( uint16_t ) 0x10,		 /*!< ADC input channel 16 */
    ADC_Channel_17     = ( uint16_t ) 0x11,		 /*!< ADC input channel 17 */
		ADC_Channel_18     = ( uint16_t ) 0x12,		 /*!< ADC input channel 18 */
    ADC_Channel_19     = ( uint16_t ) 0x13,		 /*!< ADC input channel 19 */
		ADC_Channel_TEMP   = ( uint16_t ) 0x14,		 /*!< ADC input channel TEMP */
    ADC_Channel_OP     = ( uint16_t ) 0x1E,		 /*!< ADC_CHANNEL OP */
		ADC_Channel_VDD_D4 = ( uint16_t ) 0x1F,		 /*!< ADC_CHANNEL VDD Divide 4 */
#elif defined(SC32R807)
    ADC_Channel_16     = ( uint16_t ) 0x10,		 /*!< ADC input channel 16 */
    ADC_Channel_17     = ( uint16_t ) 0x11,		 /*!< ADC input channel 17 */
		ADC_Channel_TEMP   = ( uint16_t ) 0x14,		 /*!< ADC input channel TEMP */
    ADC_Channel_OP     = ( uint16_t ) 0x1E,		 /*!< ADC_CHANNEL OP */
		ADC_Channel_VDD_D4 = ( uint16_t ) 0x1F,		 /*!< ADC_CHANNEL VDD Divide 4 */    
#elif defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)
    ADC_Channel_OP    = ( uint16_t ) 0x1E,		 /*!< ADC_CHANNEL OP */
		ADC_Channel_VDD_D4 = ( uint16_t ) 0x1F,		 /*!< ADC_CHANNEL VDD Divide 4 */
...
typedef enum
{
    ...
    ADC_EAIN_16  = ( uint32_t ) 0x00010000, /*!< ADC port 16 */
    ADC_EAIN_17  = ( uint32_t ) 0x00020000, /*!< ADC port 17 */
		ADC_EAIN_18  = ( uint32_t ) 0x00040000, /*!< ADC port 18 */
    ADC_EAIN_19  = ( uint32_t ) 0x00080000, /*!< ADC port 19 */
    ADC_EAIN_AINTEMP  = ( uint32_t ) 0x00100000, /*!< ADC AINTEMP */
    ADC_EAIN_All = ( uint32_t ) 0x0003FFFF, /*!< ADC port All */
...
typedef struct
{
    ...
    uint16_t ADC_ConvMode; /*!< Specifies ADC work conversion mode.
		...
		uint16_t Padding;  /*!< Add 2 bytes of padding to avoid the -Wpadded warning. */
} ADC_InitTypeDef;
/**
 * @}
 */
