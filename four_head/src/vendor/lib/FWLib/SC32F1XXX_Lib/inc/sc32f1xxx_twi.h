 ...
 * @{
 */
#if defined (SC32f10xx) || defined(SC32f12xx) || defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx) ||defined (SC32f15xx) || defined(SC32R601)||defined(SC32R807)
typedef enum
{
 ...
 * @{
 */
#if !(defined(SC32f15xx) || defined(SC32R601) || defined(SC32L14xx)||defined(SC32R807)||defined(SC32R807))
typedef enum
{
...
typedef enum
{
    TWI_PRESCALER_1	= ( uint16_t ) ( 0x00U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/1    */
    TWI_PRESCALER_2	= ( uint16_t ) ( 0x01U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/2    */
    TWI_PRESCALER_4	= ( uint16_t ) ( 0x02U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/4    */
    TWI_PRESCALER_8		= ( uint16_t ) ( 0x03U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/8    */
    TWI_PRESCALER_16		= ( uint16_t ) ( 0x04U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/16    */
    TWI_PRESCALER_32		= ( uint16_t ) ( 0x05U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/32    */
    TWI_PRESCALER_64		= ( uint16_t ) ( 0x06U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/64    */
    TWI_PRESCALER_128		= ( uint16_t ) ( 0x07U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/128    */
    TWI_PRESCALER_256		= ( uint16_t ) ( 0x08U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/256    */
    TWI_PRESCALER_512			= ( uint16_t ) ( 0x09U << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/512    */
    TWI_PRESCALER_1024			= ( uint16_t ) ( 0x0AU << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/1024    */
		TWI_PRESCALER_2048			= ( uint16_t ) ( 0x0BU << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/2048    */
		TWI_PRESCALER_4096			= ( uint16_t ) ( 0x0CU << TWI_CON_QTWCK_Pos ), /*!< Clock division: Fsource/4096    */
} TWI_Prescaler_TypeDef;
 ...
 * @{
 */
#if !(defined(SC32f15xx) || defined(SC32R601) || defined(SC32L14xx)||defined(SC32R807))
typedef enum
{
...
typedef enum
{
    TWI_FLAG_QTWIF = ( uint32_t ) TWI_STS_QTWIF, /*!< TWI Flag: Interrupt flag */
		TWI_FLAG_STATE = ( uint32_t ) TWI_STS_STATE, /*!<  */
    TWI_FLAG_TXRXnE = ( uint32_t ) TWI_STS_TXERXE, /*!< TWI Flag: Transmit/receive completion flag */
    TWI_FLAG_GCA = ( uint32_t ) TWI_STS_GCA, /*!< TWI Flag: Generic Call flags */
    TWI_FLAG_MSTR = ( uint32_t ) TWI_STS_MSTR, /*!< TWI Flag: Flag to identify master or slave */
} TWI_FLAG_TypeDef;

#define IS_TWI_FLAG(FLAG) (((FLAG) == TWI_FLAG_QTWIF) || \
                           ((FLAG) == TWI_FLAG_STATE) || \
													 ((FLAG) == TWI_FLAG_TXRXnE) || \
                           ((FLAG) == TWI_FLAG_GCA) || \
                           ((FLAG) == TWI_FLAG_MSTR))
...
/** @brief TWI_Constants TWI Constants
  * @{
  */
#if defined (SC32f10xx) || defined(SC32f12xx) || defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)   ||defined (SC32f15xx)||defined(SC32R807)
