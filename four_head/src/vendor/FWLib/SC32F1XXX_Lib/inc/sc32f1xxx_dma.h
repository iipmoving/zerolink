...
typedef enum
{
    ...
    DMA_Request_TWI_SPI0_TX		= ( ( uint32_t ) 0x000CU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI0 TX    */
    DMA_Request_TWI_SPI0_RX		= ( ( uint32_t ) 0x000DU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI0 RX    */
    DMA_Request_TWI_SPI1_TX		= ( ( uint32_t ) 0x000EU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI1 TX    */
    DMA_Request_TWI_SPI1_RX		= ( ( uint32_t ) 0x000FU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI1 RX    */
#endif
