...
#elif defined(SC32R803) || defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)||defined(SC32R807)
typedef enum
{
...
typedef enum
{
    RCC_SysTickSource_HCLK_DIV8 =
        ( uint8_t ) ( 0X00 << RCC_CFG1_STCLKSEL_Pos ), /*!< SysTickCLK clock = HCLK/8 */
    RCC_SysTickSource_HIRC_DIV4  =
        ( uint8_t ) ( 0X01 << RCC_CFG1_STCLKSEL_Pos ), /*!< SysTickCLK clock = HIRC/4 */
    RCC_SysTickSource_HXT_DIV2  =
        ( uint8_t ) ( 0X02 << RCC_CFG1_STCLKSEL_Pos ), /*!< SysTickCLK clock = HXT/2 */
    RCC_SysTickSource_LIRC  =
        ( uint8_t ) ( 0X03 << RCC_CFG1_STCLKSEL_Pos ), /*!< SysTickCLK clock = LIRC */
...
#define IS_RCC_SYSTICKSOURCE(SOURCE) (((SOURCE) == RCC_SysTickSource_HCLK_DIV8) || \
                                      ((SOURCE) == RCC_SysTickSource_HIRC_DIV4) || \
                                      ((SOURCE) == RCC_SysTickSource_HXT_DIV2) || \
                                      ((SOURCE) == RCC_SysTickSource_LIRC) || \
                                      ((SOURCE) == RCC_SysTickSource_LXT)|| \
                                      ((SOURCE) == RCC_SysTickSource_HCLK))
 ...
 * @{
 */
#if defined(SC32R803) || defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)|| defined(SC32f10xx)||defined(SC32R807)
typedef enum
{
...
typedef enum
{
    RCC_LXTSYSEN_Disable = ( uint32_t ) ( 0x00 << RCC_CFG0_LXTSYSEN_Pos ), /*!< Disconnect the connection between LXT and the system clock */
    RCC_LXTSYSEN_Enable  = ( uint32_t ) ( 0x01 << RCC_CFG0_LXTSYSEN_Pos ), /*!< LXT can serve as the system clock source */
} RCC_LXTSYSEN_TypeDef;

#define RCC_LXTSYSEN(LXTSYSEN) (((LXTSYSEN) == RCC_LXTSYSEN_Disable) || \
																((LXTSYSEN) == RCC_LXTSYSEN_Enable))
#endif
/**
 * @}
 */
 ...
 * @{
 */
#if defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx) || defined(SC32R803)||defined(SC32R807)
typedef enum
{
...
typedef enum
{
    ...
    RCC_AHBPeriph_CRC = ( uint8_t ) AHB_CFG_CRCEN,
    RCC_AHBPeriph_IFB = ( uint8_t ) AHB_CFG_IFBEN,
    RCC_AHBPeriph_AES = ( uint8_t ) AHB_CFG_AESEN,
    RCC_AHBPeriph_ALL = ( uint8_t ) 0X27,
} RCC_AHBPeriph_TypeDef;
#define IS_RCC_AHBPERIPH(PERIPH) ((((PERIPH) & (uint8_t)0xD8) == 0x00) && ((PERIPH) != (uint8_t)0x00))
#endif
/**
 * @}
 */
...
typedef enum
{
  ...
  RCC_APB0Periph_UART1  = (uint16_t)APB0_CFG_UART1EN,
	RCC_APB0Periph_PWM0   = (uint16_t)APB0_CFG_PWM0EN,
	RCC_APB0Periph_UART5  = (uint16_t)APB0_CFG_UART5EN,
  RCC_APB0Periph_ALL    = (uint16_t)0X03DF,
} RCC_APB0Periph_TypeDef;
#define IS_RCC_APB0PERIPH(PERIPH) ((((PERIPH) & (uint16_t)0xFC20) == 0x00) && ((PERIPH) != (uint16_t)0x00))
#endif
...
typedef enum
{
  ...
  RCC_APB1Periph_UART4      = (uint16_t)APB1_CFG_UART4EN,
	RCC_APB1Periph_UART2      = (uint16_t)APB1_CFG_UART2EN,
	RCC_APB1Periph_SC         = (uint16_t)APB1_CFG_SCEN,
  RCC_APB1Periph_ALL        = (uint16_t)0x02DF,
} RCC_APB1Periph_TypeDef;
#define IS_RCC_APB1PERIPH(PERIPH) ((((PERIPH) & (uint8_t)0xFD20) == 0x00) && ((PERIPH) != (uint16_t)0x00))
...
typedef enum
{
  RCC_APB2Periph_LCD  = (uint16_t)APB2_CFG_LCDEN,
  RCC_APB2Periph_UART3   = (uint16_t)APB2_CFG_UART3EN,
  RCC_APB2Periph_ALL   = (uint16_t)0X06,
} RCC_APB2Periph_TypeDef;
#define IS_RCC_APB2PERIPH(PERIPH) ((((PERIPH) & (uint8_t)0xF9) == 0x00) && ((PERIPH) != (uint16_t)0x00))
#endif
/**
 * @}
 */
...
* @{
*/
#if defined(SC32f10xx) ||  defined(SC32R803)||  defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)||defined(SC32R807)
typedef enum
{
...
#if defined(SC32R803) || defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)||defined(SC32R807)
...
#elif  defined(SC32R803) ||  defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx) ||defined(SC32f15xx) || defined(SC32R601)||defined(SC32R807)
typedef enum
{
	#if defined(SC32R803) ||  defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)||defined(SC32R807)
...
#endif
#if defined(SC32R803)||defined(SC32f12xx)||defined(SC32R805) || defined(SC32R806) || defined(SC32L14xx)||defined(SC32f15xx)||defined(SC32R601)||defined(SC32R807)
