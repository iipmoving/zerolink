...
typedef enum
{
    ...
    OP_InvertInput_DAC   = (uint32_t)(0x01U << OP_CON_OPNSEL_Pos),  /*!< The Invert input is DAC, OP0 doesn't have this setting  */
    OP_InvertInput_OPRF  = (uint32_t)(0x02U << OP_CON_OPNSEL_Pos),  /*!< The Invert input is OPRF, OP0 doesn't have this setting  */
...
#define IS_OP_GAN(GAN) (((GAN) == OP_PGAGain_NonInvert4_Invert3) ||   \
												((GAN) == OP_PGAGain_NonInvert8_Invert7) ||   \
												((GAN) == OP_PGAGain_NonInvert16_Invert15) ||   \
												((GAN) == OP_PGAGain_NonInvert32_Invert31))
/**
 * @}
 */
