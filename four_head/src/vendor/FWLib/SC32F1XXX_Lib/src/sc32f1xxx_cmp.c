...
#elif  defined(SC32f15xx) || defined(SC32R601)
	CMP_Negative_TypeDef ReadCMPRF = CMP3_Negative_1D16CMP_VREF;
	/* Check the parameters */
  assert_param(IS_CMP_ALL_PERIPH(CMPx));
  if(CMPx == CMP3)
	{
...
#elif defined(SC32f15xx) || defined(SC32R601)
	CMP_Positive_TypeDef ReadCMPPositive = CMP0_Positive_CMP0P;
	/* Check the parameters */
  assert_param(IS_CMP_ALL_PERIPH(CMPx));
  if(CMPx == CMP_0)
	{
...
{
	/* Check the parameters */
	CMP_NegativeSelect_TypeDef ReadCMPNegative = CMP0_1_2NegativeSelect_CMPxN;
  assert_param(IS_CMP_ALL_PERIPH(CMPx));
  if(CMPx== CMP_0)
	{
...
CMP_CMPSTA_TypeDef CMP_GetCMPSTA ( CMP_TypeDef* CMPx )
{
    ...
    return CMP_CMPSTA;
#elif defined(SC32f15xx) || defined(SC32R601)
  CMP_CMPSTA_TypeDef CMP_CMPSTA = CMP_CMP0STA_Low;
  /* Check the parameters */
  assert_param(IS_CMP_ALL_PERIPH(CMPx));
