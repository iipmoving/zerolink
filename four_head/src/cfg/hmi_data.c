...
static const HmiRoute_t s_routes_powered_off_2[] = {
    { HMI_KEY_ONOFF, HMI_EVT_LONG, HMI_ACT_GO_WORKING, 0 }
};
...
static const HmiRoute_t s_routes_working_10[] = {
    { HMI_KEY_ONOFF, HMI_EVT_LONG, HMI_ACT_GO_POWERED_OFF, 0 },
    { HMI_KEY_STOP, HMI_EVT_TAP, HMI_ACT_TOGGLE_PAUSE, 0 },
    { HMI_KEY_LOCK, HMI_EVT_LONG, HMI_ACT_TOGGLE_CHILD_LOCK, 0 },
    { HMI_KEY_LEFT_P_SET_UP, HMI_EVT_TAP, HMI_ACT_SELECT_HEAD, 0 },
    { HMI_KEY_RIGHT_P_SET_UP, HMI_EVT_TAP, HMI_ACT_SELECT_HEAD, 1 },
    { HMI_KEY_LEFT_P_SET, HMI_EVT_TAP, HMI_ACT_SELECT_HEAD, 2 },
    { HMI_KEY_RIGHT_P_SET, HMI_EVT_TAP, HMI_ACT_SELECT_HEAD, 3 }
};
...
static const HmiRoute_t s_zone_routes_selecting_17[] = {
    ...
    { HMI_KEY_POWER_0, HMI_EVT_TAP, HMI_ACT_SET_POWER, 0 },
    { HMI_KEY_POWER_1, HMI_EVT_TAP, HMI_ACT_SET_POWER, 1 },
    { HMI_KEY_POWER_2, HMI_EVT_TAP, HMI_ACT_SET_POWER, 2 },
    { HMI_KEY_POWER_3, HMI_EVT_TAP, HMI_ACT_SET_POWER, 3 },
    { HMI_KEY_POWER_4, HMI_EVT_TAP, HMI_ACT_SET_POWER, 4 },
    { HMI_KEY_POWER_5, HMI_EVT_TAP, HMI_ACT_SET_POWER, 5 },
    { HMI_KEY_POWER_6, HMI_EVT_TAP, HMI_ACT_SET_POWER, 6 },
    { HMI_KEY_POWER_7, HMI_EVT_TAP, HMI_ACT_SET_POWER, 7 },
    { HMI_KEY_POWER_8, HMI_EVT_TAP, HMI_ACT_SET_POWER, 8 },
    { HMI_KEY_POWER_9, HMI_EVT_TAP, HMI_ACT_SET_POWER, 9 },
    { HMI_KEY_POWER_9, HMI_EVT_LONG, HMI_ACT_ENTER_BOOST, 0 },
    { HMI_KEY_TIME_SET, HMI_EVT_TAP, HMI_ACT_ENTER_TIMER_SETTING, 0 }
};
...
static const HmiRoute_t s_proc_routes_timer_setting_19[] = {
    { HMI_KEY_TIME_SET, HMI_EVT_TAP, HMI_ACT_CONFIRM_TIMER, 0 },
    { HMI_KEY_TIME_SET, HMI_EVT_LONG, HMI_ACT_CANCEL_TIMER_SETTING, 0 },
    { HMI_KEY_ADD, HMI_EVT_TAP, HMI_ACT_TIMER_ADJUST, 1 },
    { HMI_KEY_SUB, HMI_EVT_TAP, HMI_ACT_TIMER_ADJUST, -1 }
};
static const HmiRoute_t s_proc_routes_timer_active_20[] = {
    { HMI_KEY_TIME_SET, HMI_EVT_TAP, HMI_ACT_ENTER_TIMER_SETTING, 1 },
    { HMI_KEY_TIME_SET, HMI_EVT_LONG, HMI_ACT_CANCEL_TIMER_ACTIVE, 0 }
};
static const HmiRoute_t s_proc_routes_boost_active_21[] = {
    { HMI_KEY_POWER_0, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 0 },
    { HMI_KEY_POWER_1, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 1 },
    { HMI_KEY_POWER_2, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 2 },
    { HMI_KEY_POWER_3, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 3 },
    { HMI_KEY_POWER_4, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 4 },
    { HMI_KEY_POWER_5, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 5 },
    { HMI_KEY_POWER_6, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 6 },
    { HMI_KEY_POWER_7, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 7 },
    { HMI_KEY_POWER_8, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 8 },
    { HMI_KEY_POWER_9, HMI_EVT_TAP, HMI_ACT_EXIT_BOOST_SET_POWER, 9 },
    { HMI_KEY_TIME_SET, HMI_EVT_TAP, HMI_ACT_ENTER_TIMER_SETTING, 0 }
};
...
static const HmiRoute_t s_child_lock_whitelist[] = {
    { HMI_KEY_ONOFF, HMI_EVT_TAP, HMI_ACT_BEEP_VALID, 0 },
    { HMI_KEY_ONOFF, HMI_EVT_LONG, HMI_ACT_BEEP_VALID, 0 }
};
