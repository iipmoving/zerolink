...
- four_head: `python ../.Codex/tools/check_deps.py . --project four_head`
- m4_ekf_observer: `python ../.Codex/tools/check_deps.py . --project m4-ekf`
...
- four_head: `python ../.Codex/tools/check_weak_pairs.py . --project four_head`
- m4_ekf_observer: `python ../.Codex/tools/check_weak_pairs.py . --project m4-ekf`
...
Check `AGENTS.md` for the project-specific compile command.
